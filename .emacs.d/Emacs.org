...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'general
    ...
    (ava/leader-keys
        ...
        "cr" '((lambda () (interactive) (play_radio)) :which-key "Play some music")
        "ci" '((lambda () (interactive) (change-light)) :which-key "Change the light of the screens")
        "cpn" '((lambda () (interactive) (play_paste)) :which-key "Play what is in the clipboard")
        "cpa" '((lambda () (interactive) (play_paste_audio)) :which-key "Play what is in the clipboard")
    ))
