...
if theme_name == "night":
    ...
    myBar = bar.Bar(
                [
                    ...
                    widget.Sep(**bar_configs),
                    widget.Memory(format='👣 {MemUsed: .2f}{ms}/{MemTotal: .2f}{ms}', measure_mem='G', foreground=colors['bar_foreground'], **bar_configs),
                    widget.Memory(format=' {SwapUsed: .2f}{ms}/{SwapTotal: .2f}{ms}', measure_swap='G', foreground=colors['bar_foreground'], **bar_configs),
                    widget.Sep(**bar_configs),
    ...
    myBar = bar.Bar(
                [
                    ...
                    widget.Memory(format='👣 {MemUsed: .2f}{ms}/{MemTotal: .2f}{ms}', measure_mem='G', foreground=colors['bar_foreground2'], background=colors['memory_bk'], **bar_configs),
                    widget.Memory(format=' {SwapUsed: .2f}{ms}/{SwapTotal: .2f}{ms}', measure_swap='G', foreground=colors['bar_foreground2'], background=colors['swap_bk'], **bar_configs),
                    # widget.Spacer(length=10, background='#000000'),
                    # widget.Systray(),
